...
class StoreLocator:
    ...
    def get_address(self, address):
        url = "https://nominatim.openstreetmap.org/search" # Endpoint for Nominatim (open street maps)
        ...
        try:
            ...
            raise ValueError("Failed to get address coordinates")
    ...
    def get_coordinates(self, store_name):
        ...
        try:
            ...
            print("Failed to parse JSON from Nominatim:", response.text)
            return []
